                ...
                {capsules.map(({ id, type, stauts, serial, launches, last_update, land_landings, water_landings, reuse_count }) => (
                    <article key={id} className="articles">
                        ...
                        <ul>
                            ...
                            <li className="mb-1">{land_landings} land_landings</li>
                            <li className="mb-1">{water_landings} water_landings</li>
                            <li className="mb-1">Reused {reuse_count} times</li>
                            {stauts === "active" ? <li className="text-emerald-500">Active</li> : 
